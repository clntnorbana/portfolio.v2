...
const data: ProjectsType[] = [
  {
    ...
    description: "A modern, responsive website developed for Klarkraft, a Norwegian energy company specializing in electricity services.",
    images: [`${image_path}/klarkraft.jpg`]
  },
  {
    title: "Brgy. Malamig Certificate Request Services System",
    ...
    description:
      "A capstone project focused on digitalizing the process for requesting and releasing certificates, such as barangay clearance and indigency. This initiative aimed to streamline operations, leading to faster transactions and improved efficiency for the Barangay Malamig Office.",
